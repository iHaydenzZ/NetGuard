...
| 测试 | cargo test（175 项）, Vitest（101 项） |
...
# 运行测试
cd src-tauri && cargo test    # 175 项 Rust 单元测试
npm test                       # 101 项前端单元测试
...
详见 [`docs/NetGuard_PRD_v1.0.md`](docs/NetGuard_PRD_v1.0.md) 第 8 节。
